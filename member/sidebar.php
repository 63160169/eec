            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php  if($_SESSION["type"] == 5){ ?> 
                        ...
                        <li> <a class="waves-effect waves-dark" href="?content=list-test" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu"></span>หลักสูตรที่ได้รับการอนุมัติ</a></li>
                    <?php } // End general User?>    
                    ...
                    <?php } // End general User?>
                    <?php  if($_SESSION["type"] == 3 || $_SESSION["type"] == 2 || $_SESSION["type"] == 1){ ?> 
                        <li> <a class="waves-effect waves-dark" href="?content=list-eb01" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu"></span>ขอรับรองหลักสูตร (EB-01)</a></li>
                    <?php } // End general User?>
                    <?php  if($_SESSION["type"] == 3 || $_SESSION["type"] == 2 || $_SESSION["type"] == 1){ ?> 
                        <li> <a class="waves-effect waves-dark" href="?content=list-eb02" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu"></span>ขออนุมัติจัดอบรมระยะสั้น (EB-02)</a></li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="?content=dashboard" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu"></span>รายงานสถิติ</a></li>
                    <?php } // End general User?>
