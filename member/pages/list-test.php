...
<div class="row page-titles">
    <div class="col-md-12 align-self-center">
        <h2 class="text-themecolor">รายการหลักสูตรที่ได้รับการอมุมัติ</h2>
    </div>
...
<div align = "right">
        <a style="font-size:36px">หลักสูตรที่เลือก</a>
        <a href = "?content=select_from_eb01"> <i class="fa fa-shopping-basket" aria-hidden="true" style= "font-size:36px;color:#1E8FD5"></i></a>
                ...
                <table class="display" id="course_list">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                           ...
                           <?php if($entry["select_status"] == 0){?>
                            <td>
                            <a href="./pages/add_select.php?id=<?php echo $entry["eb01_id"];?>" type="submit"  class="btn-basic" name="select"  id="select">
                               <i aria-hidden="true" style="background-color:#32A3E8; color:white;  border: 2px solid black;border-radius: 5px; padding: 3px; ;">&ensp;เลือก&ensp;</i>
                            </a>
                            </td>
                            <?php }else{?>
                            <td>
                            <a type="submit"  class="btn-basic" name="select"  id="select">
                            <i  aria-hidden="true" style="background-color:gray; color:white;  border: 2px solid black;border-radius: 5px; padding: 3px; ;">&ensp;เลือก&ensp;</i>
                            </a>
                            </td>
                            <?php } ?>
