...
<!-- Modal -->
<div class="modal fade" id="add_skill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h3 class="modal-title text-white" id="exampleModalLabel">เพิ่มข้อมูลทักษะ</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method = "POST" action="./php/action-add-skill.php" id="form_add">
            <div class="row">
              <div class="col-md-2">
                
              </div>
              <div class="col-md-12">
                  <label class="text-right"><b>ทักษะที่เกี่ยวข้อง<font color="red">*</font> </b></label>
