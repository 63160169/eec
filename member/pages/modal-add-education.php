...
<!-- Modal -->
<div class="modal fade" id="add_education_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method = "POST" action="./php/action-add-education-data.php" id="form_add">
            <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-12">
                  ...
                  <select name="degree" id="degree" class="form-control">
                      ...
                      <option value="<?php echo $deg["deg_id"]; ?> "> <?php echo $deg["deg_title"]; ?> </option>
          ...
          <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" value = "" class="form-control" name="faculty" id="faculty" required>
              </div>   
              <div class="col-md-6">
                <label class="text-right"><b>ภาควิชา/สาขาวิชา<font color="red">*</font></b></label>
                <input type="text" value = "" class="form-control" name="major" id="major">
              </div>
          </div> <!-- End row --> 
          <br>
          <div class="row">
