                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                           <form method="POST" action="./php/action-update-eb01.php" id="myForm" novalidate=""  >
						   
                                <div class="row">
                                    <div class="col-md-12">
											<div class="form-group">	
												<label for="title" class="control-label"><b> ชื่อหลักสูตร</b><label style="color:red;">*</label></label>
												<input type="text" name="title" id="title" value="<?php echo $data["eb01_title"]; ?>" class="form-control" <?php echo $readonly; ?> required>
										</div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
											<div class="form-group">	
												...
												<?php display_select_training_institute($con, "institute", $data["tins_id"] ,$disabled); ?> 	
												</div>
											</div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<div class="form-check">
												<input  class="form-check-input required" type="radio" value="1" id="holder" name="holder" <?php if($data["priv_id"]==1){echo "checked";}  if($readonly!=null){echo " disabled";} ?> required>
											<label class="form-check-label" > อุตสาหกรรมในพื้นที่อีอีซีที่ไม่ได้รับบีโอไอ (1)</label>
											</div>
											<div class="form-check">
												<input  class="form-check-input required" type="radio" value="2" id="holder" name="holder" <?php if($data["priv_id"]==2){echo "checked";}  if($readonly!=null){echo " disabled";} ?> required> 
												<label class="form-check-label" >อุตสาหกรรมนอกพื้นที่อีอีซีที่ไม่ได้รับบีโอไอ (2)</label>
											</div>
											<div class="form-check">
												<input  class="form-check-input required" type="radio" value="3" id="holder" name="holder" <?php if($data["priv_id"]==3){echo "checked";}  if($readonly!=null){echo " disabled";} ?> required> 
												<label class="form-check-label" > อุตสาหกรรมในพื้นที่อีอีซีที่ยังได้รับการยกเว้นภาษีเงินได้นิติบุคคลจากบีโอไอ (3)</label>
											</div>
											<div class="form-check">
												<input  class="form-check-input required" type="radio" value="4" id="holder" name="holder" <?php if($data["priv_id"]==4){echo "checked";}  if($readonly!=null){echo " disabled";} ?> required> 
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">		
											...
											<?php display_select_target_industry($con, "target_industry", $data["eb01_target"] ,$disabled); ?> 
										</div>									
									</div>			
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
										<div class="form-group">	
											...
											<input type="text" name="train_schedule" id="train_schedule" class="form-control" required value="<?php echo $data["eb01_schedule"]; ?>" <?php echo $readonly; ?>>
										</div>
                                    </div>
                                    <div class="col-md-6">
										<div class="form-group">	
											<label><b> ระยะเวลาในหารฝึกอบรม</b><label style="color:red;">*</label></label>
											<input type="text" name="train_period" id="train_period" class="form-control" required  value="<?php echo $data["eb01_period"]; ?>" <?php echo $readonly; ?>>
										</div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
										<div class="form-group">	
											...
											<input type="number" name="budget_per_gen" id="budget_per_gen" class="form-control" required value="<?php echo $data["eb01_budget_per_gen"]; ?>" <?php echo $readonly; ?>>
										</div>
                                    </div>
                                    <div class="col-md-6">
										<div class="form-group">	
											<label><b> งบประมาณทั้งหมด</b><label style="color:red;">*</label></label>
											<input type="number" name="budget_total" id="budget_total" class="form-control" required value="<?php echo $data["eb01_budget"]; ?>" <?php echo $readonly; ?>>
										</div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="target" id="target" class="form-control" required value="<?php echo $data["eb01_target_trainee"]; ?>"  <?php echo $readonly; ?>>
                                    </div>                                   
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
										<div class="form-group">	
											...
											<textarea name="intro" id="intro" class="form-control" required <?php echo $readonly; ?>><?php echo $data["eb01_intro"]; ?></textarea>                                        
										</div>                                   
                                    </div>                                   
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
										<div class="form-group">	
											...
											<textarea name="outcome" id="outcome" class="form-control" required <?php echo $readonly; ?>><?php echo $data["eb01_outcome"]; ?></textarea>                                        
                                    </div>                                                                 
                                    </div>                                   
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
										<div class="form-group">	
											...
											<textarea name="impact" id="impact" class="form-control" required <?php echo $readonly; ?>><?php echo $data["eb01_impact"]; ?></textarea>                                        
										</div>                                                                   
                                    </div>                                   
                                </div>
                                ...
                                <div class="row" id="dynamic_form">
                                    <div class="col-md-4">
										<input type="text" name="a1" id="a1"  class="form-control" <?php echo $readonly; ?> placeholder="หัวข้อ" required>
                                    </div>  
                                    <div class="col-md-4">
										<input type="text" name="a2" id="a2" class="form-control" <?php echo $readonly; ?> placeholder="Outcomes ที่เกี่ยวข้อง" required>
                                    </div>          
                                    <div class="col-md-2">
										<input type="number" name="a3" id="a3" class="form-control" <?php echo $readonly; ?> placeholder="ระยะเวลา (ชั่วโมง)" required>
                                    </div>       
								...
								<form  method="POST" action="./php/action-approve-form-eb01.php" id="appForm" novalidate=""  >
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">	
...
<script>
	$(document).ready(function() {
		...
		*/			
		...
		dynamic_form.inject([	<?php echo str_replace("\'","'",$data["eb01_detail"]); ?> ]);  //แปลงข้อมูลจาก \' เป็น ' 
