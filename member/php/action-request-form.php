<?php 
    ...
    $create = create_form_eb01($con, $title,$institute ,$target_industry,$per_total ,$per_gen, $gen,$train_schedule ,$train_period ,$budget_per_gen,$budget_total ,$target ,$intro ,$outcome ,$impact, $eb01_detail,$holder,1,$_SESSION['id']);
